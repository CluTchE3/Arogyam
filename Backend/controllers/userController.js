...
const bookAppointment = async (req, res) => {
    ...
    try {
        ...
        delete docData.slots_booked; //removing booked slots from docData //no need to store in appointment db
        ...
        //Saving booked slots to doctor database
